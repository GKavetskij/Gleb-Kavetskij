...
//Определить, сколько раз каждая десятичная цифра встречается в записи каждого числа n с чётным количеством цифр из заданной последовательности натуральных чисел.
